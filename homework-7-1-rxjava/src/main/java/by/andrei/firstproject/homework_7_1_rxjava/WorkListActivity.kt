...
import by.andrei.firstproject.homework_7_1_rxjava.adapter.OnWorkClickListener
import by.andrei.firstproject.homework_7_1_rxjava.adapter.WorkAdapter
...
class WorkListActivity : AppCompatActivity() {
    ...
    private fun checkDataBase() {
        database.getWorkFromParentsCar(parentCar)
                .subscribe{
                    workList ->
