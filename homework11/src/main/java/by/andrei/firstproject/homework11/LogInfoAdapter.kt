package by.andrei.firstproject.homework11
...
import by.andrei.firstproject.homework11.databinding.ItemRecyclerBoxBinding
    ...
    class LogViewHolder(private val binding: ItemRecyclerBoxBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(logPool: LogData) {
            ...
            binding.root.setOnClickListener {
                Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "andrei.krayushkin@gmail.com", null)).apply {
